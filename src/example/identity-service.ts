...
export const BrandEnum = z.union([
  z.literal('lebara'),
  z.literal('yallo'),
  z.literal('swype')
]);
...
export const LanguageEnum = z.union([
  z.literal('de'),
  z.literal('it'),
  z.literal('fr'),
  z.literal('en')
...
export const GdprLoginReq = z.object({
  method: z.union([
    MethodEnum_email,
    MethodEnum_phone,
    z.array(z.union([MethodEnum_email, MethodEnum_phone]))
  ]),
  brand: BrandEnum,
  value: z.string(),
...
export type AuthenticationExtensionsClientInputs = z.infer<
  typeof AuthenticationExtensionsClientInputs
>;
...
export const PublicKeyCredentialRequestOptionsJSON = z.object({
  ...
  allowCredentials: z
    .union([z.array(PublicKeyCredentialDescriptorJSON), z.undefined()])
    .optional(),
...
export type AuthenticatorAssertionResponseJSON = z.infer<
  typeof AuthenticatorAssertionResponseJSON
>;
...
export const AuthenticatorAttachment = z.union([
...
export type AuthenticationExtensionsClientOutputs = z.infer<
  typeof AuthenticationExtensionsClientOutputs
>;
